...
echo "      7. Devices, last. Not over HomeKit -- that integration"
echo "         aborts 'already_paired' before it ever asks for a"
echo "         PIN, and the path stays closed. Presence is the one"
echo "         thing worth moving, and it moves through the"
echo "         Companion app rather than a network scan: install it"
echo "         on each phone, grant Location 'Always', then attach"
echo "         the tracker under Settings > People. Nothing to"
echo "         configure here for it. If you add Nmap Tracker as a"
echo "         backstop, know that its entities arrive DISABLED --"
echo "         Home Assistant disables a tracker whose MAC no other"
echo "         integration claims -- and that scan_interval and"
echo "         consider_home appear only once the entry exists,"
echo "         under Configure. README.md, 'Getting devices in'."
echo
